from fpvdgs.status import build_status, parse_iw_info
...
def test_build_status_includes_dynamic_link_section():
    ...
    dl = {
        ...
        "running": True,
        "statsConnected": True,
        "decision": {"mcs": 4, "k": 8, "n": 12, "depth": 1, "txpowerDbm": 22, "bitrateKbps": 9000},
        "lastEmitMs": 1234,
        "emitSeq": 5,
        "reason": "snr_margin",
    }
    out = status.build_status("0.1.0", {"running": True}, {}, {"linkId": 1}, dynamic_link=dl)
...
def test_status_includes_pixelpilot_block():
    ...
    out = build_status("1.0", _runner_state(), {}, {"reachable": True}, pixelpilot=pp)
...
def test_build_status_includes_probe_when_present():
    ...
    j = build_status(
        ...
        {},
        drone_probe,
        probe={"enabled": True, "running": True, "streams": 2, "mcs": {"3": {"per": 0.0}}},
    )
...
def test_build_status_omits_probe_when_none():
    j = build_status("vX", {"running": True}, {}, {"reachable": False, "linkId": 1, "inSync": None})
...
def test_status_includes_beamforming_block():
    bf = {
        ...
        "reason": "",
        "iface": "wlan0",
        "localMac": "84:fc:14:6c:36:e6",
        "peerMac": "00:c0:ca:dd:ee:ff",
    }
    out = build_status("1.0", _runner_state(), {}, {"reachable": True}, beamforming=bf)
...
def test_build_status_includes_connection_when_passed():
    ...
    out = build_status(
        "v", {}, {}, {"linkId": 1}, connection={"state": "connected", "drone": {"version": "d1"}}
    )
