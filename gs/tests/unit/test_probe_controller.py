...
def test_measures_per_mcs_from_stdout():
    def spawn(cmd):
        return _FakeProc(
            ["1\tRX_ANT\t5805:5:20\t0\t1:-80:-80:-80:8:8:8", "1\tPKT\t10:0:0:0:1:1:0:9:0:1:0:0:0:0"]
        )
...
def test_retune_followed_via_rx_ant_key():
    ...
    def spawn(cmd):
        return _FakeProc(
            [
                "1\tRX_ANT\t5805:3:20\t0\t9:-55:-55:-55:28:28:28",
...
def test_status_exposes_age_ms_freshness():
    def spawn(cmd):
        return _FakeProc(
            [
                "1\tRX_ANT\t5805:5:20\t0\t1:-60:-60:-60:20:20:20",
